 ...
 */
final class Version20181214093115 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, provider_id INT DEFAULT NULL, image VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, ordre INT NOT NULL, INDEX IDX_C53D045FA53A8AA (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, vitrine_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, highlight TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, validated TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E19D9AD227F17893 (vitrine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
